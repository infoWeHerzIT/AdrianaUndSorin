...
// PROD-Variante: listet alle aktiven Umfragen aus der Dynamics-PROD-Umgebung
// (wht_survey, read-only). Eigene, klar benannte Secrets — getrennt von den
// DYNAMICS_*-Secrets der DEV-Function "dynamics-surveys-list-dev".
//
